...
// src/modules/issues/issues.router.ts
var router2 = Router2();
router2.post("/", auth_default(UseRole.contributor, UseRole.maintainer), issueController.createIssue);
router2.get("/", issueController.getAllIssues);
router2.get("/:id", issueController.getSingleIssue);
router2.patch("/:id", auth_default(UseRole.contributor, UseRole.maintainer), issueController.updateIssue);
router2.delete("/:id", auth_default(UseRole.maintainer), issueController.deleteIssue);
